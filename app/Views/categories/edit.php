        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="preview-kategori">
                    ...
                    <p class="mb-2" id="previewDeskripsi">
                        <?php
                    ...
                    <span class="badge <?= $aktif ? 'bg-success' : 'bg-secondary' ?>" id="previewStatus">
                        <?= $aktif
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const inputAktif     = document.getElementById('statusAktif');
        ...
        formKategori?.addEventListener('submit', () => {
            btnSimpan.disabled = true;
            btnSimpan.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span>Memperbarui...';
        });
    });
</script>
<?= $this->endSection() ?>
